...
def div_button_drop(id_button, title):
    return my_div(
        style_div_button_drop_info, "", button_drop(id_button, title, style_button_drop)
    )


def create_div_buttons(
    style_div,
    style_div_but,
    style_button,
    button_list,
...
def create_div_buttons_panel(id_panel, children):
    return my_div(style_div_panel_buttons, id_panel, children, hidden=True)
            ...
            my_div(
                ...
                [
                    my_div(
                        ...
                        "",
                        button_drop(
                            f"{id_page}_button_data", "Data", style_button_data
                        ),
                    ),
                    my_div(
...
def panel_functions(id_page):
    return my_div(
        ...
        [
            ...
            create_div_buttons_panel(
                "panel_functions",
                [
                    div_button_drop(f"{id_page}_button_drop_info", "Info"),
                    hidden_button_group(f"{id_page}_div_buttons_info", functions_info),
                    div_button_drop(f"{id_page}_button_a_g", "A-G"),
                    hidden_button_group(f"{id_page}_div_buttons_a_g", functions_a_g),
                    div_button_drop(f"{id_page}_button_h_p", "H-P"),
                    hidden_button_group(f"{id_page}_div_buttons_h_p", functions_h_p),
                    div_button_drop(f"{id_page}_button_q_z", "Q-Z"),
                    hidden_button_group(f"{id_page}_div_buttons_q_z", functions_q_z),
                ],
            ),
        ],
    )
...
def panel_visualizations(id_page):
    return my_div(
        ...
        "",
        [
            create_div_title_panel("Visualizations", "button_show_visualizations"),
            create_div_buttons_panel(
                "panel_visualizations",
                [
                    div_button_drop(f"{id_page}_button_basics", "Basics"),
                    hidden_button_group(
                        f"{id_page}_div_buttons_basics", visualizations_basic
                    ),
                    div_button_drop(f"{id_page}_button_part_of_whole", "Part Of Whole"),
                    hidden_button_group(
                        f"{id_page}_div_buttons_part_of_whole",
                        visualizations_part_of_whole,
                    ),
                    div_button_drop(
                        f"{id_page}_button_1d_distribution", "1D Distribution"
                    ),
                    hidden_button_group(
                        f"{id_page}_div_buttons_1d_distribution",
                        visualizations_1d_distribution,
                    ),
                    div_button_drop(
                        f"{id_page}_button_2d_distribution", "2D Distribution"
                    ),
                    hidden_button_group(
                        f"{id_page}_div_buttons_2d_distribution",
                        visualizations_2d_distribution,
                    ),
                    div_button_drop(
                        f"{id_page}_button_3d_dimensional", "3D Dimensional"
                    ),
                    hidden_button_group(
                        f"{id_page}_div_buttons_3d_dimensional",
        ...
        [
            ...
            create_div_buttons_panel(
                ...
                [
                    ...
                    hidden_button_group(
                        f"{id_page}_div_buttons_machine", models_supervised
                    ),
                    ...
                    hidden_button_group(
                        f"{id_page}_div_buttons_existing_models", existing_models
                    ),
    ...
    return my_div(
        ...
        [
            ...
            create_div_buttons_panel(
                "panel_workflow",
                [
                    button_group(f"{id_page}_div_workflow", workflow),
                ],
            ),
        ],
    )
