...
params_utils = [
    ...
    create_param_drop(id_page, "dummy_na", ["True", "False"], "False"),
    create_param_drop(id_page, "columns", multi=True),
    create_param_drop(id_page, "sparse", ["True", "False"], "False"),
    create_param_drop(id_page, "drop_first", ["True", "False"], "False"),
    create_param_drop(id_page, "dtype", ["int", "float", "str", "bool"], "bool"),
