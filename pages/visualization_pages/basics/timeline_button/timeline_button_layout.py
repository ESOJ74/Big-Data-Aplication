...
from .timeline_button_callbacks import *
...
params_utils = [                
                ...
                create_param_drop(id_page, "index_col"),
                create_param_drop(id_page, "show_colorbar", options=["True", "False"], value="True"),
                create_param_drop(id_page, "group_tasks", options=["True", "False"], value="True"),                       
