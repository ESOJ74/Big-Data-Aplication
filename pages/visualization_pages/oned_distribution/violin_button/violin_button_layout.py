...
from .violin_button_callbacks import *
...
params_utils = [
    ...
    create_param_drop(id_page, "box", options=["True", "False"], value="False"),
    create_param_drop(
        id_page, "points", options=["all", "outliers", "False"], value="False"
    ),
    create_param_drop(
        id_page, "violinmode", options=["overlay", "group"], value="group"
    ),
